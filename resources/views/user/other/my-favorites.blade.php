...
<!-- Mirrored from pixner.net/sbidu/main/my-favorites.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 06 Jan 2025 05:16:45 GMT -->
<head>
    <meta charset="UTF-8">
                    ...
                    <div class="dashboard-widget mb-30 mb-lg-0 sticky-menu">
                        <div class="user">
                            ...
                            <div class="content">
                                ...
                                <span class="username"><a href="https://pixner.net/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="1a707572745a7d777b737634797577">[email&#160;protected]</a></span>
                            </div>
                        </div>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="row mb-30-none justify-content-center">
                        <div class="col-sm-10 col-md-6">
                            <div class="auction-item-2" data-aos="zoom-out-up" data-aos-duration="1000">
                                <div class="auction-thumb">
                                    <a href="product-details.html"><img src="{{asset('/user/images/auction/product/04.png')}}" alt="car"></a>
                        ...
                        <div class="col-sm-10 col-md-6">
                            <div class="auction-item-2" data-aos="zoom-out-up" data-aos-duration="1000">
                                <div class="auction-thumb">
                                    <a href="product-details.html"><img src="{{asset('/user/images/auction/product/05.png')}}" alt="car"></a>
                                    <a href="#0" class="rating"><i class="far fa-star"></i></a>
                                    <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                                </div>
                                <div class="auction-content">
