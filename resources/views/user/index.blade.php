...
<body>
    ...
    <section class="jewelry-auction-section padding-bottom padding-top pos-rel">
        <div class="jewelry-bg d-none d-xl-block"><img src="{{asset('/user/images/auction/jewelry/jwelry-bg.png')}}" alt="jewelry"></div>
        <div class="container">
            <div class="section-header-3" data-aos="zoom-out-down" data-aos-duration="1200">
                <div class="left">
                    <div class="thumb">
                        <img src="{{asset('/user/images/header-icons/coin-1.png')}}" alt="header-icons">
                    </div>
                    <div class="title-area">
            ...
            <div class="row justify-content-center mb-30-none">
                <div class="col-sm-10 col-md-6 col-lg-4">
                    <div class="auction-item-2" data-aos="zoom-out-up" data-aos-duration="1300">
                        <div class="auction-thumb">
                            <a href="product-details.html"><img src="{{asset('/user/images/auction/jewelry/auction-1.jpg')}}" alt="jewelry"></a>
                            <a href="#0" class="rating"><i class="far fa-star"></i></a>
                            <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                        </div>
                        <div class="auction-content">
                ...
                <div class="col-sm-10 col-md-6 col-lg-4">
                    <div class="auction-item-2" data-aos="zoom-out-up" data-aos-duration="1500">
                        <div class="auction-thumb">
                            <a href="product-details.html"><img src="{{asset('/user/images/auction/jewelry/auction-3.jpg')}}" alt="jewelry"></a>
                            <a href="#0" class="rating"><i class="far fa-star"></i></a>
                            <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                        </div>
                        <div class="auction-content">
            ...
            <div class="row justify-content-center mb-30-none">
                <div class="col-sm-10 col-md-6 col-lg-4">
                    <div class="auction-item-2" data-aos="zoom-out-up" data-aos-duration="1600">
                        <div class="auction-thumb">
                            <a href="product-details.html"><img src="{{asset('/user/images/auction/watches/auction-1.jpg')}}" alt="watches"></a>
                            <a href="#0" class="rating"><i class="far fa-star"></i></a>
                            <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                        </div>
                        <div class="auction-content">
                ...
                <div class="col-sm-10 col-md-6 col-lg-4">
                    <div class="auction-item-2" data-aos="zoom-out-up" data-aos-duration="1700">
                        <div class="auction-thumb">
                            <a href="product-details.html"><img src="{{asset('/user/images/auction/watches/auction-2.jpg')}}" alt="watches"></a>
                            <a href="#0" class="rating"><i class="far fa-star"></i></a>
                            <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                        </div>
                        <div class="auction-content">
                ...
                <div class="col-sm-10 col-md-6 col-lg-4">
                    <div class="auction-item-2" data-aos="zoom-out-up" data-aos-duration="1800">
                        <div class="auction-thumb">
                            <a href="product-details.html"><img src="{{asset('/user/images/auction/watches/auction-3.jpg')}}" alt="watches"></a>
                            <a href="#0" class="rating"><i class="far fa-star"></i></a>
                            <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                        </div>
                        <div class="auction-content">
                ...
                <div class="row justify-content-center mb-30-none">
                    <div class="col-lg-6">
                        <div class="auction-item-3" data-aos="zoom-out-up" data-aos-duration="1500">
                            <div class="auction-thumb">
                                <a href="product-details.html"><img src="{{asset('/user/images/auction/popular/auction-1.jpg')}}" alt="popular"></a>
                                <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                            </div>
                            <div class="auction-content">
                                <h6 class="title">
                    ...
                    <div class="col-lg-6">
                        <div class="auction-item-3" data-aos="zoom-out-up" data-aos-duration="900">
                            <div class="auction-thumb">
                                <a href="product-details.html"><img src="{{asset('/user/images/auction/popular/auction-2.jpg')}}" alt="popular"></a>
                                <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                            </div>
                            <div class="auction-content">
                                <h6 class="title">
                    ...
                    <div class="col-lg-6">
                        <div class="auction-item-3" data-aos="zoom-out-up" data-aos-duration="1000">
                            <div class="auction-thumb">
                                <a href="product-details.html"><img src="{{asset('/user/images/auction/popular/auction-3.jpg')}}" alt="popular"></a>
                                <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                            </div>
                            <div class="auction-content">
                                <h6 class="title">
                    ...
                    <div class="col-lg-6">
                        <div class="auction-item-3" data-aos="zoom-out-up" data-aos-duration="1200">
                            <div class="auction-thumb">
                                <a href="product-details.html"><img src="{{asset('/user/images/auction/popular/auction-4.jpg')}}" alt="popular"></a>
                                <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                            </div>
                            <div class="auction-content">
                                <h6 class="title">
                    ...
                    <div class="col-lg-6">
                        <div class="auction-item-3" data-aos="zoom-out-up" data-aos-duration="1300">
                            <div class="auction-thumb">
                                <a href="product-details.html"><img src="{{asset('/user/images/auction/popular/auction-5.jpg')}}" alt="popular"></a>
                                <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                            </div>
                            <div class="auction-content">
                                <h6 class="title">
                    ...
                    <div class="col-lg-6">
                        <div class="auction-item-3" data-aos="zoom-out-up" data-aos-duration="1400">
                            <div class="auction-thumb">
                                <a href="product-details.html"><img src="{{asset('/user/images/auction/popular/auction-6.jpg')}}" alt="popular"></a>
                                <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                            </div>
                            <div class="auction-content">
                                <h6 class="title">
    ...
    <section class="coins-and-bullion-auction-section padding-bottom padding-top pos-rel pb-max-xl-0">
        <div class="jewelry-bg d-none d-xl-block"><img src="{{asset('/user/images/auction/coins/coin-bg.png')}}" alt="coin"></div>
        <div class="container">
            <div class="section-header-3" data-aos="zoom-out-down" data-aos-duration="1200">
                <div class="left">
                    <div class="thumb">
            ...
            <div class="row justify-content-center mb-30-none">
                <div class="col-sm-10 col-md-6 col-lg-4">
                    <div class="auction-item-2" data-aos="zoom-out-up" data-aos-duration="1900">
                        <div class="auction-thumb">
                            <a href="product-details.html"><img src="{{asset('/user/images/auction/coins/auction-1.jpg')}}" alt="coins"></a>
                            <a href="#0" class="rating"><i class="far fa-star"></i></a>
                            <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                        </div>
                        <div class="auction-content">
                ...
                <div class="col-sm-10 col-md-6 col-lg-4">
                    <div class="auction-item-2" data-aos="zoom-out-up" data-aos-duration="2000">
                        <div class="auction-thumb">
                            <a href="product-details.html"><img src="{{asset('/user/images/auction/coins/auction-2.jpg')}}" alt="coins"></a>
                            <a href="#0" class="rating"><i class="far fa-star"></i></a>
                            <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                        </div>
                        <div class="auction-content">
                ...
                <div class="col-sm-10 col-md-6 col-lg-4">
                    <div class="auction-item-2" data-aos="zoom-out-up" data-aos-duration="2100">
                        <div class="auction-thumb">
                            <a href="product-details.html"><img src="{{asset('/user/images/auction/coins/auction-3.jpg')}}" alt="coins"></a>
                            <a href="#0" class="rating"><i class="far fa-star"></i></a>
                            <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                        </div>
                        <div class="auction-content">
    ...
    <section class="real-estate-auction padding-top padding-bottom pos-rel oh">
        <div class="car-bg"><img src="{{asset('/user/images/auction/realstate/real-bg.png')}}" alt="realstate"></div>
        <div class="container">
            <div class="section-header-3" data-aos="zoom-out-down" data-aos-duration="1200">
                <div class="left">
                    <div class="thumb">
            ...
            <div class="auction-slider-4 owl-theme owl-carousel">
                <div class="auction-item-4">
                    <div class="auction-thumb">
                        <a href="product-details.html"><img src="{{asset('/user/images/auction/realstate/auction-1.png')}}" alt="realstate"></a>
                        <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                    </div>
                    <div class="auction-content">
                        <h4 class="title">
            ...
            <div class="row justify-content-center mb--50">
                <div class="col-xl-6 col-lg-8 mb-50">
                    <div class="section-header-2">
                        <div class="left">
                            <div class="thumb">
                                <img src="{{asset('/user/images/header-icons/camera-1.png')}}" alt="header-icons">
                            </div>
                    ...
                    <div class="auction-slider-1 owl-carousel owl-theme  mb-30-none">
                        <div class="slide-item">
                            <div class="auction-item-1">
                                <div class="auction-thumb">
                                    <a href="product-details.html"><img src="{{asset('/user/images/auction/electronics/auction-1.jpg')}}" alt="electronics"></a>
                                    <a href="#0" class="rating"><i class="far fa-star"></i></a>
                                    <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                                </div>
                                <div class="auction-content">
                            ...
                            <div class="auction-item-1">
                                <div class="auction-thumb">
                                    <a href="product-details.html"><img src="{{asset('/user/images/auction/electronics/auction-2.jpg')}}" alt="electronics"></a>
                                    <a href="#0" class="rating"><i class="far fa-star"></i></a>
                                    <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                                </div>
                                <div class="auction-content">
                            ...
                            <div class="auction-item-1">
                                <div class="auction-thumb">
                                    <a href="product-details.html"><img src="{{asset('/user/images/auction/electronics/auction-3.jpg')}}" alt="electronics"></a>
                                    <a href="#0" class="rating"><i class="far fa-star"></i></a>
                                    <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                                </div>
                                <div class="auction-content">
                            ...
                            <div class="auction-item-1">
                                <div class="auction-thumb">
                                    <a href="product-details.html"><img src="{{asset('/user/images/auction/electronics/auction-4.jpg')}}" alt="electronics"></a>
                                    <a href="#0" class="rating"><i class="far fa-star"></i></a>
                                    <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                                </div>
                                <div class="auction-content">
                ...
                <div class="col-xl-6 col-lg-8 mb-50">
                    <div class="section-header-2">
                        <div class="left">
                            <div class="thumb">
                                <img src="{{asset('/user/images/header-icons/art-1.png')}}" alt="header-icons">
                            </div>
                    ...
                    <div class="auction-slider-2 owl-carousel owl-theme mb-30-none">
                        <div class="slide-item">
                            <div class="auction-item-1">
                                <div class="auction-thumb">
                                    <a href="product-details.html"><img src="{{asset('/user/images/auction/art/auction-1.jpg')}}" alt="art"></a>
                                    <a href="#0" class="rating"><i class="far fa-star"></i></a>
                                    <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                                </div>
                                <div class="auction-content">
                            ...
                            <div class="auction-item-1">
                                <div class="auction-thumb">
                                    <a href="product-details.html"><img src="{{asset('/user/images/auction/art/auction-2.jpg')}}" alt="art"></a>
                                    <a href="#0" class="rating"><i class="far fa-star"></i></a>
                                    <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                                </div>
                                <div class="auction-content">
                            ...
                            <div class="auction-item-1">
                                <div class="auction-thumb">
                                    <a href="product-details.html"><img src="{{asset('/user/images/auction/art/auction-3.jpg')}}" alt="art"></a>
                                    <a href="#0" class="rating"><i class="far fa-star"></i></a>
                                    <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                                </div>
                                <div class="auction-content">
                            ...
                            <div class="auction-item-1">
                                <div class="auction-thumb">
                                    <a href="product-details.html"><img src="{{asset('/user/images/auction/art/auction-4.jpg')}}" alt="art"></a>
                                    <a href="#0" class="rating"><i class="far fa-star"></i></a>
                                    <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                                </div>
                                <div class="auction-content">
            ...
            <div class="container">
                <div class="row mb--60">
                    ...
                    <div class="col-sm-6 col-lg-3" data-aos="fade-down" data-aos-duration="1600">
                        <div class="footer-widget widget-links">
                            <h5 class="title">Were Here to Help</h5>
                            <ul class="links-list">
                                <li>
                    ...
                    <div class="col-sm-6 col-lg-3" data-aos="fade-down" data-aos-duration="1800">
                        <div class="footer-widget widget-follow">
                            ...
                            <ul class="links-list">
                                ...
                                <li>
                                    <a href="#0"><i class="fas fa-envelope-open-text"></i><span class="__cf_email__" data-cfemail="4d2528213d0d28232a223925282028632e2220">[email&#160;protected]</span></a>
                                </li>
                                <li>
